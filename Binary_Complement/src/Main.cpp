...
// * In two's-complement, negating a number is done by inverting (swapping 0s and 1s) all the bits and then adding one to that result
// * (look at the image 2° in the README file).
